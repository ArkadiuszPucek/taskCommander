...
import com.arcadio.domain.taskStatus.TaskTypeFacade;
...
public class TaskService {
    ...
    private final TaskTypeFacade taskTypeFacade;
    private final TaskFactory taskFactory;
    private final UserTaskFacade userTaskFacade;
//    private final UserRatingFacade userRatingFacade;


    public TaskService(TaskRepository taskRepository, TaskTypeFacade taskTypeFacade, TaskFactory taskFactory, UserTaskFacade userTaskFacade) {
